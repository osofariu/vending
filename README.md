...
This project was generated using maven:

```
mvn archetype:generate -DgroupId=learn.katas -DartifactId=vending -DarchetypeArtifactId=maven-archetype-quickstart -DarchetypeVersion=1.4 -DinteractiveMode=false
```


This kata was created by Guy Royce: https://github.com/guyroyse/vending-machine-kata
